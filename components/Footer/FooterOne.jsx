              ...
              <div className="col-xl-3 col-lg-4 col-md-6">
                ...
                >
                  ...
                  <div className="footer-content">
                    <p>
                      A DAO swap and token that enables community solutions. A true self-sustainable solution for community Building, management and Development
              ...
              <div className="col-xl-4 col-lg-4 col-md-6">
                ...
                >
                  ...
                  <div className="footer-newsletter">
                    <p>
                     Signup for our newsletters and community updates!
                    </p>
                    <form action="#">
                      <input
                        type="email"
            ...
            <div className="row align-items-center">
              <div className="col-lg-6">
                <div className="copyright-text">
                  <p>Copyright &copy; 2023. All Rights Reserved ACOM.FINANCE</p>
                </div>
              </div>
